...
public class RutThamTrungThuongSource {
    private HashSet<String> rutThamTrungThuong;
    //Constructor
    public RutThamTrungThuongSource() {
        this.rutThamTrungThuong = new HashSet<String>();
    }
    //Get, set
    public HashSet<String> getRutThamTrungThuong() {
        return this.rutThamTrungThuong;
    }

    public void setRutThamTrungThuong(HashSet<String> rutThamTrungThuong) {
